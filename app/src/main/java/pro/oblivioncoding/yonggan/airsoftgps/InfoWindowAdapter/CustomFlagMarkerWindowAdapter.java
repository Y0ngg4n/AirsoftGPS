...
public class CustomFlagMarkerWindowAdapter implements GoogleMap.InfoWindowAdapter {
    ...
    public CustomFlagMarkerWindowAdapter(Context context, double latitude, double longitude, String title, String description, String username) {
        mContext = context;
